...
public class Server implements Runnable {
    ...
    private static String localContext = "./frontend/"; // File context on local machine to serve requested files (NOT related to Java imports, this is for HTTP connections) -Kyle
